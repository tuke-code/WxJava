...
import com.binarywang.spring.starter.wxjava.store.properties.WxStoreSingleProperties;
...
//        break;
  ...
  private void configApp(WxStoreDefaultConfigImpl config, WxStoreSingleProperties wxStoreSingleProperties) {
    ...
    config.setApiHostUrl(StringUtils.trimToNull(wxStoreSingleProperties.getApiHostUrl()));
    config.setAccessTokenUrl(StringUtils.trimToNull(wxStoreSingleProperties.getAccessTokenUrl()));
  }
