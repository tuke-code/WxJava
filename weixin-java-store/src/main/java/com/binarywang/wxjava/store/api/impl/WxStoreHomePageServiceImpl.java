...
import static com.binarywang.wxjava.store.constant.WxStoreApiUrlConstants.HomePage.*;


import lombok.extern.slf4j.Slf4j;
import com.binarywang.wxjava.store.api.WxStoreHomePageService;
...
import com.binarywang.wxjava.store.bean.home.banner.BannerApplyParam;
...
import com.binarywang.wxjava.store.bean.home.tree.TreeProductEditParam;
import com.binarywang.wxjava.store.bean.home.tree.TreeProductListInfo;
import com.binarywang.wxjava.store.bean.home.tree.TreeProductListParam;
...
import com.binarywang.wxjava.store.bean.home.tree.TreeShowParam;
import com.binarywang.wxjava.store.bean.home.tree.TreeShowSetResponse;
import com.binarywang.wxjava.store.bean.home.window.WindowProductIndexParam;
import com.binarywang.wxjava.store.bean.home.window.WindowProductListParam;
import com.binarywang.wxjava.store.bean.home.window.WindowProductSetting;
...
public class WxStoreHomePageServiceImpl implements WxStoreHomePageService {
  ...
  public WxStoreHomePageServiceImpl(BaseWxStoreServiceImpl<?, ?> storeService) {
    this.storeService = storeService;
  }


  @Override
  public WxStoreBaseResponse addTreeProduct(TreeProductEditInfo info) throws WxErrorException {
  ...
  @Override
  public WxStoreBaseResponse delTreeProduct(TreeProductEditInfo info) throws WxErrorException {
    TreeProductEditParam param = new TreeProductEditParam(info);
  ...
  @Override
  public WxStoreBaseResponse reorderWindowProduct(String productId, Integer indexNum) throws WxErrorException {
  ...
  @Override
  public WxStoreBaseResponse hideWindowProduct(String productId, Integer setHide) throws WxErrorException {
  ...
  @Override
  public WxStoreBaseResponse topWindowProduct(String productId, Integer setTop) throws WxErrorException {
    WindowProductSetting param = new WindowProductSetting();
    param.setProductId(productId);
  ...
  @Override
  public WxStoreBaseResponse cancelBackground(Integer applyId) throws WxErrorException {
  ...
  @Override
  public WxStoreBaseResponse removeBackground() throws WxErrorException {
  ...
  @Override
  public WxStoreBaseResponse cancelBanner(Integer applyId) throws WxErrorException {
    String paramJson = "{\"apply_id\":" + applyId + "}";
  ...
  @Override
  public WxStoreBaseResponse removeBanner() throws WxErrorException {
