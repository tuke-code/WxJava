...
public class HttpComponentsStoreFileUploadRequestExecutor extends StoreFileUploadRequestExecutor<CloseableHttpClient, HttpHost> {
  public HttpComponentsStoreFileUploadRequestExecutor(RequestHttp<CloseableHttpClient, HttpHost> requestHttp) {
    super(requestHttp);
  }
