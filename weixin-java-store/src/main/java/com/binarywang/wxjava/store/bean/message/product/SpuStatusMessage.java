package com.binarywang.wxjava.store.bean.message.product;
...
public class SpuStatusMessage extends WxStoreMessage {
  ...
  /** 当前商品上下架状态 参考 {@link com.binarywang.wxjava.store.enums.SpuStatus } */
  @JsonProperty("status")
