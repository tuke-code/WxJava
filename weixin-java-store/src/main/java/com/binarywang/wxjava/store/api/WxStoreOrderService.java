...
public interface WxStoreOrderService {
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse updatePrice(String orderId, Integer expressFee, List<ChangeOrderInfo> changeOrderInfos)
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse updateRemark(String orderId, String merchantNotes) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse updateAddress(String orderId, AddressInfo userAddress) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse updateDelivery(DeliveryUpdateParam param) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse acceptAddressModify(String orderId) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse rejectAddressModify(String orderId) throws WxErrorException;
   ...
   * @return BaseResponse
   */
  WxStoreBaseResponse closeOrder(String orderId);
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse deliveryOrder(String orderId, List<DeliveryInfo> deliveryList) throws WxErrorException;
   ...
   * 注意事项：<br />
   *  1. 非生鲜质检的订单不能进行上传 <br />
   *  2. 图片url必须用图片上传接口获取 {@link WxStoreBasicService#uploadImg(int, String)}<br />
   *
   * @param orderId 订单id
   * @param items   商品打包信息
   * @return BaseResponse
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse uploadFreshInspect(String orderId, List<PackageAuditInfo> items) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse addPresentNote(String orderId, String note) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse approvePreShipmentChangeSku(String orderId) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse rejectPreShipmentChangeSku(String orderId, String rejectReason) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse applyRealNumber(String orderId) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse applyVirtualNumberAgain(String orderId) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse delayVirtualNumber(String orderId) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse addPrivatePhone(String phone) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse sendPrivatePhoneVerifyCode(String phone) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse compensationDelivery(OrderCompensationDeliveryParam param) throws WxErrorException;
}
