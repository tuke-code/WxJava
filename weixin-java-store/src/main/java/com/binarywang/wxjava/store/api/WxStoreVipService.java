...
import com.binarywang.wxjava.store.bean.vip.VipInfoResponse;
import com.binarywang.wxjava.store.bean.vip.VipListResponse;
import com.binarywang.wxjava.store.bean.vip.VipScoreResponse;
 ...
 */
public interface WxStoreVipService {
  /** 拉取用户详情 */
   ...
   * @throws WxErrorException the wx error exception
   */
  WxStoreBaseResponse increaseVipScore(String openId, String score, String remark, String requestId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxStoreBaseResponse decreaseVipScore(String openId, String score, String remark, String requestId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxStoreBaseResponse updateVipGrade(String openId, Integer score) throws WxErrorException;
