 ...
 */
public interface BaseWxStoreService extends WxService {
   ...
   * WxStoreConfig对象
   *
   * @return WxMaConfig WxStoreConfig
   */
  WxStoreConfig getConfig();

  /**
   * 注入 {@link WxStoreConfig} 的实现.
   *
   * @param config config
   */
  void setConfig(WxStoreConfig config);
