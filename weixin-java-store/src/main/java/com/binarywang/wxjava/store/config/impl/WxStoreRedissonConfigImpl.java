 ...
 * created on  2020/5/3
 */
public class WxStoreRedissonConfigImpl extends WxStoreDefaultConfigImpl {
  ...
  public WxStoreRedissonConfigImpl(@NonNull RedissonClient redissonClient, String keyPrefix) {
    this(new RedissonWxRedisOps(redissonClient), keyPrefix);
  }

  public WxStoreRedissonConfigImpl(@NonNull RedissonClient redissonClient) {
    this(redissonClient, null);
  }

  private WxStoreRedissonConfigImpl(@NonNull WxRedisOps redisOps, String keyPrefix) {
