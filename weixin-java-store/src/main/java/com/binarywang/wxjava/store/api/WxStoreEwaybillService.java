 ...
 */
public interface WxStoreEwaybillService {
  ...
  WxStoreBaseResponse deleteTemplate(String templateId) throws WxErrorException;

  /** 更新商家面单模板。 @param req 官方模板更新字段 @return 操作结果 @throws WxErrorException 调用失败 */
  WxStoreBaseResponse updateTemplate(TemplateUpdateRequest req) throws WxErrorException;
  ...
  WxStoreBaseResponse addSubOrder(AddSubOrderRequest req) throws WxErrorException;

  /** 取消电子面单下单。 @param waybillId 运单 ID @return 操作结果 @throws WxErrorException 调用失败 */
  WxStoreBaseResponse cancelOrder(PrintOrderRequest req) throws WxErrorException;
  ...
  WxStoreBaseResponse printOrder(PrintOrderRequest req) throws WxErrorException;

  /** 批量通知运单打印成功。 @param waybillIds 运单 ID 列表 @return 操作结果 @throws WxErrorException 调用失败 */
  WxStoreBaseResponse batchPrintOrder(BatchPrintOrderRequest req) throws WxErrorException;
}
