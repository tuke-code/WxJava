...
import com.binarywang.wxjava.store.api.WxStoreCategoryService;
import com.binarywang.wxjava.store.bean.audit.AuditApplyResponse;
import com.binarywang.wxjava.store.bean.audit.AuditResponse;
import com.binarywang.wxjava.store.bean.audit.CategoryAuditInfo;
import com.binarywang.wxjava.store.bean.audit.CategoryAuditRequest;
import com.binarywang.wxjava.store.bean.base.WxStoreBaseResponse;
import com.binarywang.wxjava.store.bean.category.*;
...
import static com.binarywang.wxjava.store.constant.WxStoreApiUrlConstants.Category.*;
 ...
 */
@Slf4j
public class WxStoreCategoryServiceImpl implements WxStoreCategoryService {

  /** 微信商店服务 */
  private final BaseWxStoreServiceImpl<?, ?> shopService;

  public WxStoreCategoryServiceImpl(BaseWxStoreServiceImpl<?, ?> shopService) {
  ...
  @Override
  public WxStoreBaseResponse cancelCategoryAudit(String auditId) throws WxErrorException {
