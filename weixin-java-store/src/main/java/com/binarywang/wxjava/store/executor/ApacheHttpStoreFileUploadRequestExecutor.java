...
public class ApacheHttpStoreFileUploadRequestExecutor extends StoreFileUploadRequestExecutor<CloseableHttpClient, HttpHost> {
  public ApacheHttpStoreFileUploadRequestExecutor(RequestHttp<CloseableHttpClient, HttpHost> requestHttp) {
    super(requestHttp);
  }
