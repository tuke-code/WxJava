 ...
 */
public interface WxStoreBrandService {
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse cancelBrandApply(String brandId, String auditId) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse deleteBrandApply(String brandId) throws WxErrorException;
