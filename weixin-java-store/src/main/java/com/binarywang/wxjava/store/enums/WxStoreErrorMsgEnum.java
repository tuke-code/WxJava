 ...
 * @deprecated 请使用 {@link me.chanjar.weixin.common.error.WxStoreErrorMsgEnum} 替代
 */
@Deprecated
@Getter
public enum WxStoreErrorMsgEnum {
  /**
  ...
  WxStoreErrorMsgEnum(int code, String msg) {
    this.code = code;
    this.msg = msg;
  }
  ...
  static {
    for (WxStoreErrorMsgEnum value : WxStoreErrorMsgEnum.values()) {
