 ...
 */
public interface WxStoreCategoryService {
   ...
   *
   * @throws WxErrorException 异常
   * @see WxStoreBasicService#uploadQualificationFile(File)
   ...
   * @throws WxErrorException 异常
   */
  WxStoreBaseResponse cancelCategoryAudit(String auditId) throws WxErrorException;
